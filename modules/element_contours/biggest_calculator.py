...
class BiggestElementCalculator:
    def __init__(self, threshold_func: Callable[[Any], Any], isModeTree: bool) -> None:
        self.__threshold_func = threshold_func
        self.__mode = isModeTree and cv2.RETR_TREE or cv2.RETR_CCOMP

    def execute(self, image: str, is_sorted=False) -> Contours:
        ...
        return Contours(sortedContours, hierarchy, is_sorted=True)
